      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm">
            De ao Skyller instrucoes e informacoes relevantes para as conversas dentro de {projectName}. Isso funcionara junto com as preferencias do usuario e o estilo selecionado em uma conversa.
          </DialogDescription>
        </DialogHeader>
