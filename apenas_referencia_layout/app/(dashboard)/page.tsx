...
import { mockAgents, conversationSuggestions, mockMessages, type Message, type Artifact } from "@/lib/mock/data"
import { TrendingUp, FileSearch, DollarSign, Scale, Palette, Search, Upload, Cloud, FolderKanban, LayoutGrid, Presentation, ChevronDown, Plus, Sparkles } from "lucide-react"
          ...
          {messages.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground text-sm max-w-md mx-auto mb-6">
                Pergunte qualquer coisa. Posso ajudar com pesquisa, escrita, codigo, analise de dados e mais.
              </p>
              
              {/* Conversation Suggestions */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-w-xl mx-auto">
                {conversationSuggestions.map((suggestion) => {
                  const SuggestionIcon = suggestion.icon === 'TrendingUp' ? TrendingUp 
                    : suggestion.icon === 'FileSearch' ? FileSearch 
                    : suggestion.icon === 'Code2' ? Code2 
                    : FileText
                  return (
                    <button
                      key={suggestion.id}
...
function ArtifactPreview({ artifact }: { artifact: Artifact }) {
  ...
  return (
    <Card className="border-dashed hover:border-accent/50 transition-colors cursor-pointer" onClick={() => openPanel('artifact', artifact)}>
      ...
      <CardContent className="py-2 px-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          <Button variant="outline" size="sm" className="h-7 text-xs bg-transparent" onClick={(e) => {
            e.stopPropagation()
            openPanel('artifact', artifact)
          }}>
