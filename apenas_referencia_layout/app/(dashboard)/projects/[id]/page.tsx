...
import { formatRelativeTime } from "@/lib/utils" // Import formatRelativeTime function
import {
  ArrowLeft,
  Send,
  Plus,
...
import { mockProjects, mockWorkspaces, mockConversations } from "@/lib/mock/data"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="sm" asChild>
                <Link href={`/projects?workspace=${project.workspaceId}`} className="flex items-center gap-2">
                ...
                <div className="w-full max-w-2xl">
                  ...
                  <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-dashed">
                    <p className="text-sm text-center text-muted-foreground">
                      Inicie uma conversa para manter as conversas organizadas e reutilizar o conhecimento do projeto.
                    </p>
                  </div>
      ...
      <div className="w-80 border-l bg-muted/20 flex-shrink-0 hidden lg:block">
        <ScrollArea className="h-full">
          <div className="p-4 space-y-4">
            ...
            {/* Instrucoes */}
            <Collapsible open={isInstructionsSectionOpen} onOpenChange={setIsInstructionsSectionOpen}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between cursor-pointer hover:bg-accent/50 rounded-lg p-2 -m-2">
              ...
              <CollapsibleContent>
                <div className="mt-4 p-6 border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Adicione PDFs, documentos ou outros textos para usar como referencia neste projeto.
                  </p>
                </div>
              </CollapsibleContent>
            </Collapsible>
            ...
            {/* Conversas Recentes */}
            <div>
              <h3 className="font-medium text-sm mb-3">Conversas Recentes</h3>
              {projectConversations.length > 0 ? (
                <div className="space-y-2">
                  {projectConversations.slice(0, 5).map((conv) => (
                    <div 
                      key={conv.id}
                ...
                <p className="text-xs text-muted-foreground">
                  Nenhuma conversa ainda neste projeto.
                </p>
              )}
            </div>
          </div>
