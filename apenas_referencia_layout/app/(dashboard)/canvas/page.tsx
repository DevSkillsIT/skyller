...
import { mockCanvasCards, type CanvasCard } from "@/lib/mock/data"
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              />
              <Label htmlFor="json-toggle" className="text-sm">JSON</Label>
            </div>
          </div>
        </div>
                  ...
                  <DropdownMenuTrigger asChild>
                    <div className="text-center p-6">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Arraste cards aqui ou<br />clique para adicionar
                      </p>
                    </div>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent>
...
function ProjectCardContent({ card, onUpdate }: { card: CanvasCard; onUpdate: (card: CanvasCard) => void }) {
  const content = card.content as { status?: string; dueDate?: string; checklist?: Array<{ id: string; text: string; checked: boolean }> }
