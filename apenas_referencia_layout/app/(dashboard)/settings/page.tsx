          ...
          {activeSection === 'agents' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <RadioGroup value={routingMode} onValueChange={(v) => setRoutingMode(v as 'auto' | 'fixed')}>
          ...
          {activeSection === 'permissions' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Configure as permissoes de acesso
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Outros podem copiar este projeto</p>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-destructive/50">
                <CardHeader>
                  ...
                  <CardDescription>
                    Esta acao nao pode ser desfeita. Todos os dados, conversas e documentos serao permanentemente excluidos.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Button
