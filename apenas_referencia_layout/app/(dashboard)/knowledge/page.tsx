...
const columns: ColumnDef<Document>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span className={`inline-flex items-center justify-center w-10 h-6 rounded text-[10px] font-bold border ${getDocumentIconColor(type)}`}>
      ...
      <div className="flex flex-col h-full p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            {documents.length} documentos - {formatBytes(totalSize)} total - RAG ativo ({indexedCount} indexados)
          </p>
        </div>
        ...
        >
          {uploadProgress !== null ? (
            ...
            <>
              ...
              <span className="text-xs text-muted-foreground hidden sm:block">PDF, DOCX, TXT, MD, XLSX</span>
            </>
          )}
        </div>
