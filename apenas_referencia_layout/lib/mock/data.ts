...
export const mockWorkspaces: Workspace[] = [
  { id: 'ws1', name: 'Desenvolvimento', icon: '💻', projectsCount: 5 },
  { id: 'ws2', name: 'Clientes', icon: '🏢', projectsCount: 12 },
  { id: 'ws3', name: 'Administrativo', icon: '📋', projectsCount: 3 },
]
...
export const mockProjects: Project[] = [
  { 
    ...
    customInstructions: 'Você é um assistente especializado em desenvolvimento de software. Sempre responda com exemplos de código quando relevante.'
  },
  { 
    id: 'p2', 
    workspaceId: 'ws1', 
...
export const mockConversations: Conversation[] = [
  // Chats em Projetos
  { id: 'c1', projectId: 'p1', title: 'Analise Q4 2025', lastMessage: '2 min atras', updatedAt: new Date(), messageCount: 12 },
  { id: 'c2', projectId: 'p1', title: 'Codigo auth', lastMessage: '15 min atras', updatedAt: new Date(Date.now() - 15 * 60000), messageCount: 8 },
  { id: 'c3', projectId: 'p1', title: 'Arquitetura RAG', lastMessage: '1h atras', updatedAt: new Date(Date.now() - 60 * 60000), messageCount: 24 },
  { id: 'c4', projectId: 'p1', title: 'Relatorio de Vendas', lastMessage: '2h atras', updatedAt: new Date(Date.now() - 120 * 60000), messageCount: 6 },
  { id: 'c5', projectId: 'p2', title: 'API Design', lastMessage: '3h atras', updatedAt: new Date(Date.now() - 180 * 60000), messageCount: 15 },
  { id: 'c6', projectId: 'p2', title: 'Database Schema', lastMessage: '5h atras', updatedAt: new Date(Date.now() - 300 * 60000), messageCount: 9 },
  { id: 'c7', projectId: 'p3', title: 'React Native Setup', lastMessage: '1d atras', updatedAt: new Date(Date.now() - 24 * 60 * 60000), messageCount: 18 },
  { id: 'c8', projectId: 'p4', title: 'Proposta Comercial', lastMessage: '2d atras', updatedAt: new Date(Date.now() - 48 * 60 * 60000), messageCount: 7 },
  
  // Chats Soltos (projectId = null) - Padrao de mercado (ChatGPT, Claude, Gemini)
  { id: 'cs1', projectId: null, title: 'Como fazer um bolo de chocolate?', lastMessage: '30 min atras', updatedAt: new Date(Date.now() - 30 * 60000), messageCount: 4 },
  { id: 'cs2', projectId: null, title: 'Explicar quantum computing', lastMessage: '1h atras', updatedAt: new Date(Date.now() - 60 * 60000), messageCount: 8 },
  { id: 'cs3', projectId: null, title: 'Ideias para presente de aniversario', lastMessage: '3h atras', updatedAt: new Date(Date.now() - 180 * 60000), messageCount: 6 },
  { id: 'cs4', projectId: null, title: 'Resumo do livro Sapiens', lastMessage: '1d atras', updatedAt: new Date(Date.now() - 24 * 60 * 60000), messageCount: 12 },
  { id: 'cs5', projectId: null, title: 'Dicas de produtividade', lastMessage: '2d atras', updatedAt: new Date(Date.now() - 48 * 60 * 60000), messageCount: 10 },
]
...
export const mockAgents: Agent[] = [
  {
    ...
    icon: 'Bot',
    description: 'Responde qualquer pergunta, roteia internamente para especialistas quando necessário.',
...
export const mockDocuments: Document[] = [
  { id: 'd1', projectId: 'p1', name: 'arquitetura.md', size: 45000, type: 'md', status: 'indexed', createdAt: new Date() },
  { id: 'd2', projectId: 'p1', name: 'roadmap-2026.pdf', size: 2400000, type: 'pdf', status: 'indexed', createdAt: new Date() },
  { id: 'd3', projectId: 'p1', name: 'requisitos-v2.docx', size: 890000, type: 'docx', status: 'processing', createdAt: new Date() },
  { id: 'd4', projectId: 'p1', name: 'api-reference.md', size: 120000, type: 'md', status: 'indexed', createdAt: new Date() },
  { id: 'd5', projectId: 'p1', name: 'briefing-ui.md', size: 85000, type: 'md', status: 'indexed', createdAt: new Date() },
  { id: 'd6', projectId: 'p1', name: 'contrato-cliente.pdf', size: 1500000, type: 'pdf', status: 'indexed', createdAt: new Date() },
  { id: 'd7', projectId: 'p1', name: 'metricas-q4.xlsx', size: 340000, type: 'xlsx', status: 'indexed', createdAt: new Date() },
  { id: 'd8', projectId: 'p1', name: 'deploy-guide.txt', size: 15000, type: 'txt', status: 'indexed', createdAt: new Date() },
  { id: 'd9', projectId: 'p1', name: 'error-logs.txt', size: 8000, type: 'txt', status: 'error', createdAt: new Date() },
  { id: 'd10', projectId: 'p1', name: 'database-schema.md', size: 32000, type: 'md', status: 'indexed', createdAt: new Date() },
  { id: 'd11', projectId: 'p1', name: 'user-stories.docx', size: 560000, type: 'docx', status: 'indexed', createdAt: new Date() },
  { id: 'd12', projectId: 'p1', name: 'security-audit.pdf', size: 3200000, type: 'pdf', status: 'indexed', createdAt: new Date() },
]
...
export function getStatusColor(status: Document['status']): 'default' | 'secondary' | 'destructive' {
