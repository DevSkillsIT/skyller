  ...
  if (!workspace) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8">
        ...
        <p className="text-muted-foreground mb-4">O workspace que voce esta procurando nao existe.</p>
              ...
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between cursor-pointer hover:bg-accent/50 rounded-lg p-2 -m-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ChevronDown
                      className={cn("h-4 w-4 transition-transform", isProjectsOpen && "rotate-180")}
                    />
                  </div>
                </div>
              </CollapsibleTrigger>
            ...
            >
              ...
              <CollapsibleContent>
                {instructions ? (
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Adicionar instrucoes para personalizar as respostas do Skyller neste workspace.
                  </p>
                )}
              </CollapsibleContent>
            </Collapsible>
