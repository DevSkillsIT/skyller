    ...
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
        ...
        <p className="text-sm text-muted-foreground">
          Esta página expõe o chat padrão do CopilotKit como base de comparação. Útil para validação
          de comportamento e UX antes de levar melhorias para o chat customizado.
        </p>
      </div>
